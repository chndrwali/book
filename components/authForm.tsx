            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>{field.name === 'universityCard' ? <ImageUpload /> : <Input required type={FIELD_TYPES[field.name as keyof typeof FIELD_TYPES]} {...field} className="form-input" />}</FormControl>
                  <FormMessage />
                </FormItem>
              )}
            />
